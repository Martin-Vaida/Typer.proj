...
class KingsmanIIViewController:UITableViewController {
        ...
        timer = Timer.scheduledTimer(withTimeInterval: 0.1, repeats: true, block: { _ in
            ...
            if MenuViewController.forceQuite {
                if self.timeCounter >= 60.0 {
                    ...
                    ScoreViewController.score = Score(String(correctLetters), String(tappedLetters), self.timePassed, false, "Kingsman Collection II")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        ScoreViewController.score = Score(String(correctLetters), String(tappedLetters), timePassed, false, "Kingsman Collection II")
    }
